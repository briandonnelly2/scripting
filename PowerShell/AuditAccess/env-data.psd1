...
@{
    ...
    @(
        @{
            ...
            adusrsecgroup   =   "UK-SG PR App Support Admin",
                                "UK-SG_TTG_ADMIN",
                                "UK-SG TaxWorkflow_Support"

            rousrsecgroup   =   "UK-SG RO App Support Access"
    ...
    @(
        @{
            ...
            adminopsgroup   =   "UK-SG PR-OP PROD-WorkflowTC"

            roopsgroup      =   "UK-SG RO-OP PROD-WorkflowTC"

            admindatagroup  =   "UK-SG PR-DA PROD-WorkflowTC"

            rodatagroup     =   "UK-SG RO-DA PROD-WorkflowTC"
        }
    )
    ...
    @(
        @{
            ...
            adminopsgroup   =   "UK-SG PR-OP PROD-WorkflowPA"

            roopsgroup      =   "UK-SG RO-OP PROD-WorkflowPA"

            admindatagroup  =   "UK-SG PR-DA PROD-WorkflowPA"

            rodatagroup     =   "UK-SG RO-DA PROD-WorkflowPA"
        }
    )
    ...
    @(
        @{
            ...
            adminopsgroup   =   "UK-SG PR-OP UAT-Workflow"

            roopsgroup      =   ""

            admindatagroup  =   "UK-SG PR-DA UAT-Workflow"
    ...
    @(
        @{
            ...
            adminopsgroup   =   "UKX-SG PR-OP DEV-Workflow"

            roopsgroup      =   ""

            admindatagroup  =   "UKX-SG PR-DA DEV-Workflow"
    ...
    @(
        @{
            ...
            adminopsgroup   =   "UKX-SG PR-OP QA-Workflow"

            roopsgroup      =   ""

            admindatagroup  =   "UKX-SG PR-DA QA-Workflow"
