...
GO
	...
	inner join taxywincoe_staging..client c on c.entityid = be.billableentityid
	INNER JOIN taxywincoe_staging..taxform tf ON tf.clientid = c.clientid --AND tf.[YEAR] = @Year
