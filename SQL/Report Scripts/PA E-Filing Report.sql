...
from DIGITATAX.TaxywinSecure1.dbo.Client c

inner join DIGITATAX.TaxywinSecure1.dbo.fbiSubmissions fbi on fbi.lclientid = c.clientid
inner join DIGITATAX.TaxywinSecure1.dbo.fbiStatusRef fbis on fbis.lid = fbi.lstatusid
...
from DIGITATAX.TaxywinSecure1.dbo.Partnership p

inner join DIGITATAX.TaxywinSecure1.dbo.PartnershipfbiSubmissions pfbi on pfbi.lPartnershipID = p.pclientid
inner join DIGITATAX.TaxywinSecure1.dbo.fbiStatusRef fbis on fbis.lid = pfbi.lstatusid
